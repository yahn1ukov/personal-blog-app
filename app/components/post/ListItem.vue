...
<template>
  <li class="flex h-full">
    <NuxtLink
      ...
      class="flex flex-col w-full border border-black rounded-md overflow-hidden transition-all duration-300 ease-in-out hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[2px_2px_0px_0px_black] hover:bg-neutral-50 hover:brightness-[0.97]"
    >
